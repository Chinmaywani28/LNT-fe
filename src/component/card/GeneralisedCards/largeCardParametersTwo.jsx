...
const LargeCardParametersTwo = ({ Data, chartData,openSidebar }) => {
...
const labelsData =
  ...
  return (
    ...
    <Card className="em-card" sx={{width: 600 , bgcolor: '#FFF8E1'}}>
      

  {/* Header */}
  <div className="em-header">
    <div>
      <h3>OB EM.10F AHU POWER. PLINC1</h3>
      <p>
...
export default LargeCardParametersTwo;
